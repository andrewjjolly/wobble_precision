...
for r in range(len(data.orders)):
        ...
        model.add_star('star', learning_rate_rvs=100)
...
results.write_rvs('star', 'results_rvs_lr100.txt', all_orders=True) #results txt contains a column for each order
results.write('results_no_bad_orders_lr100.hdf5')